...
def main():
    ...
    while True:  # cur_itrs < opts.total_itrs:
        ...
        for (images, labels) in train_loader:
            ...
            outputs = model(images, feat_align=True)
            trans_outputs = model(trans_images, feat_align=True)
            # trans_outputs_feat = model(images, feat_align=True)
            ...
            loss = 0.5 * (loss_seg_out +  loss_seg_trans)
            loss.backward()
            optimizer.step()
