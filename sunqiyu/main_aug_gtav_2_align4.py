...
def main():
    ...
    while True:  # cur_itrs < opts.total_itrs:
        ...
        for (images, labels) in train_loader:
            ...
            #feature_align
            vectors, ids = calculate_mean_vector(f_out.detach(), outputs_raw,  labels=labels)
            ...
            t_vectors, t_ids = calculate_mean_vector(t_f_out.detach(), trans_outputs_raw, labels=labels)
            ...
            #feature_align
            low_vectors, low_ids = calculate_mean_vector(f_low.detach(), outputs_raw, labels=labels)
            ...
            low_t_vectors, low_t_ids = calculate_mean_vector(t_f_low.detach(), trans_outputs_raw, labels=labels)
