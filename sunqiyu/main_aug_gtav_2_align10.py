...
def main():
    ...
    while True:  # cur_itrs < opts.total_itrs:
        ...
        for (images, labels) in train_loader:
            ...
            loss = (0.5 * (loss_seg_out + loss_seg_trans + loss_seg)  + feature_false_loss)-constractive_loss
            ...
            if (cur_itrs) % 10 == 0:
                ...
                print("Epoch %d, Itrs %d/%d, Loss=%f,  False_feature_loss=%f, Cons_loss=%f" %
                      (cur_epochs, cur_itrs, opts.total_itrs, interval_loss,  interval_false_loss, interval_cons_loss))
                interval_loss = 0.0
